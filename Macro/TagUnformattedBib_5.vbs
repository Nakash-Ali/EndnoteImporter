...
Sub TagRecordRefType()
    ...
    ' Chapter in a book
    refTypeBookSec.Patterns.Add "x--*. " & "[" & ChrW(8216) & ChrW(34) & ChrW(8220) & "]" & "*" & "[" & ChrW(8217) & ChrW(34) & ChrW(8221) & "]" & "* [iI]n * <i>*</i>, ed. *. *, [0-9n][0-9.][0-9d]*."
    ...
    refTypeJournal.Patterns.Add "x--*. " & "[" & ChrW(8216) & ChrW(34) & ChrW(8220) & "]" & "*" & "[" & ChrW(8217) & ChrW(34) & ChrW(8221) & "]" & ", <i>*</i>, vol. *, *p. #*."
