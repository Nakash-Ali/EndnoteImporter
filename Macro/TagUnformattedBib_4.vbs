...
Sub TagRecordRefType()
    ...
    refTypeBook.Patterns.Add "x--*. <i>*</i>, *. *, [0-9n][0-9.][0-9d]*.*"
    ' Chapter in a book
    refTypeBook.Patterns.Add "x--*. " & "[" & ChrW(8216) & "," & ChrW(8220) & "]" & "*" & "[" & ChrW(8217) & "," & ChrW(8221) & "]" & ", in <i>*</i>, ed. *. *, [0-9n][0-9.][0-9d]*."

    ' Regex patterns for Book Section:
    ' --------------------------------
    ' Basic Book Section
    refTypeBookSec.Patterns.Add "x--*. " & "[" & ChrW(8216) & "," & ChrW(8220) & "]" & "*" & "[" & ChrW(8217) & "," & ChrW(8221) & "]" & " In <i>*</i>, *. *####*.*"
    ...
    refTypeJournal.Patterns.Add "x--*. " & "[" & ChrW(8216) & "," & ChrW(8220) & "]" & "*" & "[" & ChrW(8217) & "," & ChrW(8221) & "]" & ", <i>*</i>, vol. *, *p. #*."
    ' Journal Article with "issueNo (date): pages"
    refTypeJournal.Patterns.Add "x--*. " & "[" & ChrW(8216) & "," & ChrW(8220) & "]" & "*" & "[" & ChrW(8217) & "," & ChrW(8221) & "]" & "* <i>*</i> *#* (#*#): #*#."
...
Sub TagItalic()
    ...
    Do While Selection.Find.Execute(Replace:=wdReplaceOne) = True
        ...
        If Selection.Previous(Count:=3) = "<i>" Then
