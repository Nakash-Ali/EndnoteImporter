...
Sub TagRecordRefType()
    ...
    refTypeBook.Patterns.Add "x--*. <i>*</i>, *. *, [0-9n][0-9.][0-9d]*.*"
    ' Chapter in a book
    refTypeBook.Patterns.Add "x--*. " & ChrW(8216) & "<i>*</i>" & ChrW(8217) & ", in <i>*</i>, ed. *. *, [0-9n][0-9.][0-9d]*."

    ' Regex patterns for Journal Articles:
    ' ------------------------------------
    ' Basic Journal Article with issue no. and volume'
    refTypeJournal.Patterns.Add "x--*. ""*."" <i>*</i> #*, no. #* (#*): #*."
    ' Basic Journal Article with volume as vol. and without issue no.
    ' "*. '*', <i>*</i>, vol. *, *p. #*."
    refTypeJournal.Patterns.Add "x--*. " & ChrW(8216) & "*" & ChrW(8217) & ", <i>*</i>, vol. *, *p. #*."
    ...
    Dim refTypes(1 To 3) As ReferenceType
